...
//************************************************************************
    ...
    */
     ...
     *
     * @return 	List<CompanyFetchOneSummary> 
	...
	public void addToDivisions( AssignDivisionsToCompanyCommand command ) throws ProcessingException {
		...
		// -------------------------------------------
		try {		
	/*		Division childToAdd = childId == null ? null : childDelegate.getDivision( new DivisionFetchOneSummary(childId) );
				
			// -------------------------------------------
			// if not found, create it
			// -------------------------------------------
			if ( childToAdd == null ) {
				childToAdd = childDelegate.createDivision( command );
			}
...
//			Division childToRemove = childDelegate.getDivision(new DivisionFetchOneSummary( childId ));
...
//			command.setRemoveFrom( childToRemove );
	...
	public void addToBoardMembers( AssignBoardMembersToCompanyCommand command ) throws ProcessingException {
		...
		// -------------------------------------------
		try {		
	/*		Employee childToAdd = childId == null ? null : childDelegate.getEmployee( new EmployeeFetchOneSummary(childId) );
				
			// -------------------------------------------
			// if not found, create it
			// -------------------------------------------
			if ( childToAdd == null ) {
				childToAdd = childDelegate.createEmployee( command );
			}
...
//			Employee childToRemove = childDelegate.getEmployee(new EmployeeFetchOneSummary( childId ));
