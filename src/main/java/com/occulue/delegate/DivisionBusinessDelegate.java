...
//************************************************************************
    ...
    */
     ...
     *
     * @return 	List<DivisionFetchOneSummary> 
	...
	public void assignHead( PromoteToDivisionHeadCommand command ) throws ProcessingException {
		...
		try {
	        ...
	        // --------------------------------------------------------------
/*			if ( childId != null )
				child = childDelegate.getEmployee( new EmployeeFetchOneSummary( childId ) );
			else // otherwise create it
				child = childDelegate.createEmployee( child );
...
*/
	...
	public void addToDepartments( AssignDepartmentsToDivisionCommand command ) throws ProcessingException {
		...
		// -------------------------------------------
		try {		
	/*		Department childToAdd = childId == null ? null : childDelegate.getDepartment( new DepartmentFetchOneSummary(childId) );
				
			// -------------------------------------------
			// if not found, create it
			// -------------------------------------------
			if ( childToAdd == null ) {
				childToAdd = childDelegate.createDepartment( command );
			}
...
//			Department childToRemove = childDelegate.getDepartment(new DepartmentFetchOneSummary( childId ));
